...
public class pickUpItems : NetworkBehaviour
{
    ...
    private void OnDrop(InputAction.CallbackContext context)
    {
        if (heldObject != null)
        {
            ...
            // Aquí el jugador suelta el objeto, cambia la propiedad de vuelta al host o al servidor.
            if (IsOwner)
            {
                // Si el jugador es el dueño, puede soltar el objeto y cambiar la propiedad.
